...
/* ACESSANDO DATABASE E VENDO AS TABELAS */
...
/* INSERINDO OS NOVOS DADOS NAS TABELAS */
...
/* RELETORIO GERAL DE TODOS OS CLIENTES */ 
...
/* RELETORIO GERAL DE TODOS OS CLIENTES MASCULINOS */
...
/* DANDO UPDATE NOS REGISTROS ERRADOS - 12, 13, 18, 19 */	
...
/* RELETORIO GERAL DE TODOS OS CLIENTES FEMININOS */
...
/* DANDO UPDATE NOS REGISTROS ERRADOS - 16 */
...
SELECT C.IDCLIENTE, C.NOME, C.EMAIL, C.SEXO, E.BAIRRO, E.CIDADE, E.ESTADO,
	T.TIPO, T.NUMERO
FROM CLIENTE C
	INNER JOIN ENDERECO E  
	ON C.IDCLIENTE = E.ID_CLIENTE
